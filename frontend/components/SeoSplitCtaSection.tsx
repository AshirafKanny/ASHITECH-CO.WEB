          ...
          <div className="relative grid md:grid-cols-2">
            <article className="flex flex-col items-start gap-4 px-6 py-7 sm:flex-row sm:items-center sm:gap-5 sm:px-7 sm:py-8 lg:px-9 lg:py-9">
              ...
              <Link
                ...
                className="grid h-12 w-12 place-items-center rounded-full bg-white text-black transition-transform duration-200 hover:scale-105 active:scale-95 sm:ml-auto"
              >
