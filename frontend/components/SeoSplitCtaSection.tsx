      ...
      <div className="mx-auto w-full max-w-7xl px-4">
        <div className="relative overflow-hidden border border-white/10">
          ...
          <div className="relative grid md:grid-cols-2">
            <article className="flex items-center gap-5 px-7 py-8 lg:px-9 lg:py-9">
              ...
              <h3 className="max-w-xs text-3xl font-semibold leading-tight text-white lg:text-4xl">
              ...
              <button
                ...
                className="ml-auto grid h-12 w-12 place-items-center rounded-full border border-white/70 text-white transition-colors hover:bg-white hover:text-[#0F172A]"
              >
                <ArrowRight size={24} strokeWidth={1.9} aria-hidden="true" />
              </button>
            </article>

            <article className="relative flex items-center gap-5 border-t border-white/15 px-7 py-8 md:border-l md:border-t-0 lg:px-9 lg:py-9">
              <span className="grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#ff6b3d] text-white lg:h-16 lg:w-16">
                <Target size={28} strokeWidth={2.1} aria-hidden="true" />
              </span>
